...
describe('ItemList', function()
    describe('add', function()
        it('adds valid items', function()
            local keymap =
                Keymap:parse({ '<leader><leader>', function() end, description = 'test' })
    ...
    describe('filter', function()
        it('filters items with a single filter', function()
            local keymap =
                Keymap:parse({ '<leader><leader>', function() end, description = 'test func' })
            local command =
                Command:parse({ ':MyCommand', function() end, description = 'test cmd' })
            local list = ItemList:create()
        ...
        it('filters items with multiple filters', function()
            local keymap =
                Keymap:parse({ '<leader><leader>', function() end, description = 'test func' })
            local keymap2 =
                Keymap:parse({ '<leader><leader>', function() end, description = 'test func 2' })
            local command =
                Command:parse({ ':MyCommand', function() end, description = 'test cmd' })
            local list = ItemList:create()
